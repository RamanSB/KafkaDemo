...
public class ProducerCreator {
    ...
    public static Producer<Long, String> createProducer(){
        ...
        props.put(ProducerConfig.CLIENT_ID_CONFIG, IKafkaConstants.CLIENT_ID); //ToDo: ID of the Producer. Allows broker to be aware of who is requesting to publish a message to a kafka topic.
        ...
        //This property determines to which partition a message will be written to.
